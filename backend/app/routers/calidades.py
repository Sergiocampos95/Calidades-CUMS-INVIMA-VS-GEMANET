...
def _calidades(carpeta: Path) -> list[Calidad]:
    ...
    assert actual is not None  # _tabla_auditoria ya encontro datos -> tiene que haber snapshot
    ...
    _CACHE_CALIDADES[clave] = (actual.nombre, calidades)
    return calidades
